...
//   transition: cx 1500ms;
//   transition: cy 1500ms;
// `;
// Types
						...
						{data.map((d) => {
							return (
								<circle
									...
									cx={getX(d, maxDist)}
									cy={getY(d, maxDist)}
									// cx={planetsLayout === 'byDistance' ? getX(d, maxDist) : timeScale(d.pl_discYear)}
									// cy={planetsLayout === 'byDistance' ? getY(d, maxDist) : stackScale(d.indexInYear)}
									r={2}
